...
class TestVersion1(unittest.TestCase):
    ...
    def test_get_config_value(self):
        ...
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aString1") == "Hello, world!"
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aString2") == "Hello again!"
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("anInt1") == 684
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("anInt2") == 6844534686
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aFloat1") == 464286.5435414
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aFloat2") == 3.14
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aBool1") == True
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aBool2") == False

        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aString1") == "Hello, world!"
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aString2") == "Hello again!"
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("anInt1") == 684
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("anInt2") == 6844534686
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aFloat1") == 464286.5435414
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aFloat2") == 3.14
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aBool1") == True
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aBool2") == False
    ...
    def test_set_config_value(self):
        ...
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aString1") == "This is a new string."
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aString2") == "This is another string."
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("anInt1") == 31854
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("anInt2") == 6468435135846843
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aFloat1") == 4354351.254684354
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aFloat2") == 184.84
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aBool1") == False
        assert config_handler.Version1("test/v1-testconfig.dat", False).get("aBool2") == True

        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aString1") == "This is a new string."
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aString2") == "This is another string."
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("anInt1") == 31854
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("anInt2") == 6468435135846843
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aFloat1") == 4354351.254684354
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aFloat2") == 184.84
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aBool1") == False
        assert config_handler.Version1("test/v1-testconfig-base64.conf", True).get("aBool2") == True
...
def run():
    ...
    os.remove("test/v1-testconfig.dat")
    os.remove("test/v1-testconfig-base64.conf")
